function guardar(){
    ...
    fetch("https://comfy-choux-4df887.netlify.app/.netlify/functions/usuarios", requestOptions)
      .then((response) => {
...
function listar(){
    ...
    fetch("https://comfy-choux-4df887.netlify.app/.netlify/functions/usuarios?iden="+ndoc, requestOptions)
      .then((response) =>
        response.text())
      .then((result) =>
        cargar(result))
